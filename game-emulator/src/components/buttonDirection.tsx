...
export default function CreateButtonDirection({
  ...
  return (
    <div className="button-direction">
      <button className="up" onClick={() => onButtonPress("UP")}>
        ▲
      </button>
      <button className="right" onClick={() => onButtonPress("RIGHT")}>
        ▶
      </button>
      <button className="down" onClick={() => onButtonPress("DOWN")}>
        ▼
      </button>
      <button className="left" onClick={() => onButtonPress("LEFT")}>
        ◀
      </button>
    </div>
  );
